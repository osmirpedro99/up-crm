...
class Installer extends Command
{
     ...
     * @var string
     */
    protected $signature = 'upperfy-crm:install
     ...
     * @var string
     */
    protected $description = 'upperfy installer.';
    ...
    public function handle()
    {
        ...
        $this->warn('Step: Seeding basic data for Upperfy kickstart...');
        $this->info(app(UpperfyDatabaseSeeder::class)->run([
    ...
    protected function createAdminCredentials()
    {
        ...
        try {
            ...
            File::put($filePath, 'Upperfy is successfully installed');

            $this->info('-----------------------------');
            $this->info('Congratulations!');
            $this->info('The installation has been finished and you can now use Upperfy.');
